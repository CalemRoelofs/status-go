...
var (
	...
	testBalanceMapPerChain = map[string]*big.Int{
		...
		makeBalanceKey(walletCommon.BSCMainnet, walletCommon.UsdcSymbol):      big.NewInt(testAmount1USDCInBSC),
	}
)
...
func getNormalTestParamsList() []normalTestParams {
	return []normalTestParams{
		{
			name: "Transfer - No Chains Provided",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
			...
			expectedError:      requests.ErrNoFromChainProvided,
			expectedCandidates: routes.Route{},
		},
		{
			name: "Transfer - No To Chain Provided",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Transfer,
			...
			expectedError:      requests.ErrNoToChainProvided,
			expectedCandidates: routes.Route{},
		},
		{
			name: "Transfer - No From Chain Provided",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Transfer,
				...
				AmountIn:    (*hexutil.Big)(big.NewInt(testAmount1ETHInWei)),
				TokenID:     walletCommon.EthSymbol,
				ToChainID:   walletCommon.EthereumMainnet,
		...
		},
		{
			...
			input: &requests.RouteInputParams{
				...
				AmountIn:    (*hexutil.Big)(big.NewInt(testAmount1ETHInWei)),
				TokenID:     walletCommon.EthSymbol,
				FromChainID: walletCommon.OptimismMainnet,
		...
		{
			name: "ETH bridge - Specific Single FromChain - Specific Single ToChain - Same Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
		...
		{
			name: "ETH bridge - Specific Single FromChain - Specific Single ToChain - Different Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Bridge,
				...
				TokenID:     walletCommon.EthSymbol,
				FromChainID: walletCommon.EthereumMainnet,
				ToChainID:   walletCommon.ArbitrumMainnet,
		...
		{
			name: "BNB transfer - Specific Single FromChain - Specific Single ToChain - Different Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Transfer,
		...
		{
			name: "BNB bridge - Specific Single FromChain - Specific Single ToChain - Same Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Bridge,
		...
		{
			name: "BNB bridge - Specific Single FromChain - Specific Single ToChain - Different Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Bridge,
		...
		},
		{
			...
			input: &requests.RouteInputParams{
				...
				TokenID:     walletCommon.BNBSymbol,
				FromChainID: walletCommon.BSCMainnet,
				ToChainID:   walletCommon.BSCMainnet,
		...
		{
			name: "ERC20 bridge - Specific Single FromChain - Specific Single ToChain - Same Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Bridge,
		...
		{
			name: "ERC20 bridge - Specific Single FromChain - Specific Single ToChain - Different Chains",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Bridge,
		...
		},
		{
			...
			input: &requests.RouteInputParams{
				...
				TokenID:     walletCommon.UsdcSymbol,
				FromChainID: walletCommon.ArbitrumMainnet,
				ToChainID:   walletCommon.EthereumMainnet,
...
func getNoBalanceTestParamsList() []noBalanceTestParams {
	return []noBalanceTestParams{
		...
		{
			name: "ERC20 transfer - Specific FromChain - Specific ToChain - Enough Token Balance On Arbitrum Chain But Not Enough Native Balance",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Transfer,
		...
		{
			name: "ERC20 transfer - Specific FromChain - Specific ToChain - Enough Token Balance On Arbitrum Chain And Enough Native Balance On Arbitrum Chain",
			input: &requests.RouteInputParams{
				TestnetMode: false,
				Uuid:        uuid.NewString(),
				SendType:    sendtype.Transfer,
